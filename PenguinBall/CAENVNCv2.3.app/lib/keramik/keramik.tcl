...
#
# $Id: keramik.tcl,v 1.6 2006/08/04 09:01:31 patthoyts Exp $

package require Tk 8.4;                 # minimum version of Tk
package require tile 0.5;               # minimum version of tile
...
namespace eval tile::theme::keramik {
    ...
    style theme create keramik -parent alt -settings {
        ...
        style element create Horizontal.Progressbar.pbar image $I(hsb-n) \
            -border {6 4}
        
        style element create Vertical.Progressbar.pbar image $I(vsb-n) \
            -border {4 6}
        
        foreach dir {up down left right} {
            style element create ${dir}arrow image $I(arrow${dir}-n) \
                -map [list {pressed !disabled} $I(arrow${dir}-p)] \
                -sticky {}
        }
        ...
        style configure TNotebook -padding 2 -tabmargins {2 0 2 0}
        style map TNotebook.Tab \
            -expand [list active {2 0 2 0} selected {2 0 2 0}]
